...
AAS_URL="${AAS_URL:-http://trunk-aas:8081}"
DT_ID="${DT_ID:-trunk_dt}"
SHELL_ID="${SHELL_ID:-https://edt.local/aas/trunk_dt}"
SM_ID="${SM_ID:-https://edt.local/aas/trunk_dt/submodels/trunk_measurement}"
...
SM_BODY=$(cat <<EOF
{
  ...
  "id": "$SM_ID",
  "submodelElements": [
    { "idShort": "diameter_mm",    "modelType": "Property", "valueType": "xs:double", "value": "0" },
    { "idShort": "sap_flow_rate",  "modelType": "Property", "valueType": "xs:double", "value": "0" },
