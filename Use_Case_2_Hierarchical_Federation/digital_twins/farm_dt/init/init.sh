...
AAS_URL="${AAS_URL:-http://farm-aas:8081}"
DT_ID="${DT_ID:-farm_dt}"
SHELL_ID="${SHELL_ID:-https://edt.local/aas/farm_dt}"
SM_ID="${SM_ID:-https://edt.local/aas/farm_dt/submodels/farm_management}"
DELEGATE_URL="${DELEGATE_URL:-http://farm-logic:5005/invoke/trigger}"
...
SM_BODY=$(cat <<EOF
{
  ...
  "submodelElements": [
    ...
    {
      "idShort": "last_assessment_result",
      "modelType": "Property",
      "valueType": "xs:string",
      "value": ""
    },
